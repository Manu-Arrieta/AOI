...
> _Memoria persistente entre sesiones, optimización medida de tokens, contratos conductuales sin ambigüedad y runtime espaciotemporal con recuperación de los efectos que él mismo registra._

---

[![AOI Doctor](https://img.shields.io/badge/AOI_Doctor-360%C2%B0_Healthy-success?style=for-the-badge&logo=shield)](11-Diagnostico-Gobernanza-y-AOI-Doctor)
[![Tests](https://img.shields.io/badge/Tests-Verified-brightgreen?style=for-the-badge&logo=vitest)](01-Estructura-y-Arquitectura)
[![Scaffold Parity](https://img.shields.io/badge/Scaffold_Parity-Verified-blue?style=for-the-badge)](01-Estructura-y-Arquitectura)
[![Multi-Harness](https://img.shields.io/badge/Multi--Harness-Verified-orange?style=for-the-badge)](06-Funcionalidades-y-Herramientas)
...
- **Les da memoria persistente entre sesiones (ICM v4):** Un cerebro persistente en tu computadora donde guardan recuerdos, planos de arquitectura y datos exactos que nunca se olvidan.
...
| :---------------------------------------------- | :------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------ |
| **1. Enjambre de Agentes**                      | Tenés especialistas con roles claros (uno para frontend, uno para backend, uno para testing, etc.). | Nadie se pisa los pies; cada tarea la hace el mejor experto.              |
...
| **5. Ahorro de Tokens**                        | Comprime las herramientas y la información que le pasas al modelo.                                      | Tu factura de IA baja radicalmente y la IA responde 10 veces más rápido.  |
...
```mermaid
graph LR
    subgraph Fundamentos["1. Fundamentos & Sistema"]
        A1["01. Estructura y Arquitectura"]
        A2["02. Componentes del Sistema"]
        A3["03. Paradigmas Fundamentales"]
        A4["04. Estudios Científicos"]
    end

    subgraph Operacion["2. Agentes & Operación"]
        B1["05. Ecosistema de Agentes"]
        B2["06. Funcionalidades y Herramientas"]
        B3["07. Ciclo de Vida SDD"]
        B4["08. Dashboard C2"]
    end

    subgraph Practica["3. Práctica & Control"]
        C1["09. Benchmarks de Tokens"]
        C2["10. Guía Práctica y Ejemplos"]
        C3["11. AOI Doctor y Salud"]
        C4["12. Cheat Sheet y Comandos"]
    end

    Fundamentos --> Operacion
    Operacion --> Practica
```
...
- [**05. Ecosistema de Agentes y Roles**](05-Ecosistema-de-Agentes-y-Roles): Quién es quién entre los agentes y cómo colaboran sin desorden.

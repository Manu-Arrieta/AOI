...
> *Memoria infinita persistente, optimización matemática de tokens, contratos conductuales sin ambigüedad y runtime espaciotemporal con reversión atómica de efectos.*
...
[![Tests Passing](https://img.shields.io/badge/Tests-134%2F134_Passing-brightgreen?style=for-the-badge&logo=vitest)](01-Estructura-y-Arquitectura)
[![Scaffold Parity](https://img.shields.io/badge/Scaffold_Parity-228%2F228_Verified-blue?style=for-the-badge)](01-Estructura-y-Arquitectura)
[![Multi-Harness](https://img.shields.io/badge/Multi--Harness-5_Assistants-orange?style=for-the-badge)](06-Funcionalidades-y-Herramientas)
[![License](https://img.shields.io/badge/License-MIT-purple?style=for-the-badge)](https://opensource.org/licenses/MIT)

---

## 💡 ¿Qué es AOI explicado en palabras simples? (Para Humanos)
...
* **Reemplaza los pedidos vagos por contratos claros (BIC):** En lugar de decirles *"hazme un botón para cobrar"*, un diálogo guiado les enseña exactamente qué hacer y qué **NUNCA** deben permitir.
...
| **4. Reversión en 0 Tokens ($\partial\Gamma$)** | Si un test falla, el sistema vuelve atrás automáticamente en 0 milisegundos. | No gastas dinero pidiéndole al bot *"por favor arregla lo que rompiste"*. |

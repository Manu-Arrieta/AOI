...
export const dashboardMessages = {
  en: {
    ...
    dagViewer: {
      ...
      title: 'Execution DAG Matrix',
      copy: 'Autonomous task nodes and dependency resolution wave graph.',
      noNodes: 'No structured DAG tasks discovered in tasks.md yet.',
      dependencies: 'Depends on',
      noDependencies: 'Root task',
      targetFiles: 'Target files',
      role: 'Agent role',
      testRequirements: 'TDD requirements',
      statusPending: 'Pending',
      statusReady: 'Ready',
      statusInProgress: 'In progress',
      statusCompleted: 'Completed',
      statusHealing: 'Self-healing',
      statusFailed: 'Circuit breaker tripped',
      pause: 'Pause',
      resume: 'Resume',
      stepWave: 'Step Wave',
      retryWave: 'Retry Wave',
      nodeInspector: 'Node Inspector',
      microAgentPayload: 'Micro-Agent Payload',
      astContractGuard: 'Polyglot AST Invariants',
      consensusScore: 'Consensus Gate Score',
      tokenGovernorBudget: 'Token Budget Status',
  ...
  es: {
    ...
    dagViewer: {
      eyebrow: 'Runtime AOI-OS',
      title: 'Matriz DAG de Ejecución',
      copy: 'Nodos de tareas autónomas y grafo de olas de dependencias.',
      noNodes: 'Todavía no se descubrieron tareas DAG estructuradas en tasks.md.',
      dependencies: 'Depende de',
      noDependencies: 'Tarea raíz',
      targetFiles: 'Archivos objetivo',
      role: 'Rol de agente',
      testRequirements: 'Requisitos TDD',
      statusPending: 'Pendiente',
      statusReady: 'Lista',
      statusInProgress: 'En curso',
      statusCompleted: 'Completada',
      statusHealing: 'Auto-sanación',
      statusFailed: 'Circuit breaker disparado',
      pause: 'Pausar',
      resume: 'Reanudar',
      stepWave: 'Avanzar Ola',
      retryWave: 'Reintentar Ola',
      nodeInspector: 'Inspector de Nodo',
      microAgentPayload: 'Payload de Micro-Agente',
      astContractGuard: 'Invariantes AST Políglota',
      consensusScore: 'Score de Consensus Gate',
      tokenGovernorBudget: 'Estado de Presupuesto',

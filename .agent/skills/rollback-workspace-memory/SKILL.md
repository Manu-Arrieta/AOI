# Roll Back Workspace Memory (Antigravity)

> Antigravity mirror of `.github/prompts/rollback-workspace-memory.prompt.md`. Logic is identical.
...
This skill activates when the user says: "rollback-workspace-memory", "rollback de memorias", "restaurar memoria", or similar.

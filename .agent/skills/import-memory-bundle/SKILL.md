# Import Memory Bundle (Antigravity)

> Antigravity mirror of `.github/prompts/import-memory-bundle.prompt.md`. Logic is identical.
...
This skill activates when the user says: "import-memory-bundle", "importar
bundle de memorias", "import memory bundle", or similar.

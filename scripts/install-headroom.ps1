...
Warn "AVISO: NO corra 'headroom learn --apply' durante sesiones AOI activas — puede modificar copilot-instructions.md sin awareness AOI. Use --dry-run y revise diff primero."
exit 0

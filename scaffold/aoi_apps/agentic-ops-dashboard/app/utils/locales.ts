...
export const dashboardMessages = {
  en: {
    ...
    artifactsPanel: {
      ...
      sourceView: 'Source .md',
      renderedBadge: 'Interpreted',
      rawBadge: 'Raw',
      pathInfo: 'Artifact path',
      noExtension: 'n/a',
      sddPipeline: 'SDD Lifecycle Pipeline',
      phaseGate: 'Phase Gate',
      gateArtifacts: 'Gate deliverables',
      filterAll: 'All',
      phases: {
        explore: 'Explore',
        specify: 'Specify',
    ...
    doctor: {
      ...
      checking: 'Checking diagnostics…',
      runCheck: 'Run AOI Doctor',
      allPassed: 'All workspace health gates are passing.',
      modalTitle: 'AOI 360° Health Diagnostic',
      mandatory: 'Mandatory',
      optional: 'Optional',
    },
    facts: {
      title: 'Facts Explorer',
      eyebrow: 'Deterministic Memory',
      copy: 'Exact key-value facts registered with O(1) deterministic access in ICM.',
      searchPlaceholder: 'Search facts by key, value, or entity…',
      allNamespaces: 'All Namespaces',
      noFacts: 'No facts registered for this workspace yet.',
      cliHint: 'Register facts via CLI: icm facts set <entity> <key> <value>',
    },
    memoir: {
      title: 'Memoirs Knowledge Graph',
      eyebrow: 'Architectural Memory',
      copy: 'High-level concepts, domain models, and dependencies curated in ICM Memoirs.',
      searchPlaceholder: 'Search concepts, tags, dependencies…',
      noConcepts: 'No architectural concepts found in memoir.',
  ...
  es: {
    ...
    artifactsPanel: {
      ...
      sourceView: 'Código .md',
      renderedBadge: 'Interpretado',
      rawBadge: 'Fuente',
      pathInfo: 'Ruta del artefacto',
      noExtension: 's/d',
      sddPipeline: 'Pipeline del Ciclo SDD',
      phaseGate: 'Compuerta de Fase',
      gateArtifacts: 'Entregables de compuerta',
      filterAll: 'Todos',
      phases: {
        explore: 'Exploración',
    ...
    tokenMetrics: {
      ...
      contextHealth: 'Salud de contexto',
      healthOptimal: 'Óptima',
      healthModerate: 'Moderada',
      healthBloat: 'Sobrecarga alta',
      tokens: 'tokens',
      calls: 'llamadas',
      breakdown: 'Desglose',
      activity: 'Actividad',
    ...
    doctor: {
      title: 'Salud del Workspace',
      eyebrow: 'Diagnostico',
      healthyBadge: 'Saludable',
      issuesBadge: 'Incidencias',
      checking: 'Verificando diagnostico…',
      runCheck: 'Ejecutar AOI Doctor',
      allPassed: 'Todos los controles de salud del workspace estan pasando.',
      modalTitle: 'Diagnostico de Salud 360° AOI',
      mandatory: 'Obligatorio',
      optional: 'Opcional',
    },
    facts: {
      title: 'Explorador de Facts',
      eyebrow: 'Memoria Determinista',
      copy: 'Hechos clave-valor exactos registrados con acceso determinista O(1) en ICM.',
      searchPlaceholder: 'Buscar facts por clave, valor o entidad…',
      allNamespaces: 'Todos los Namespaces',
      noFacts: 'Todavia no hay facts registrados para este workspace.',
      cliHint: 'Registra facts via CLI: icm facts set <entity> <key> <value>',
    },
    memoir: {
      title: 'Grafo de Conocimiento (Memoirs)',
      eyebrow: 'Memoria Arquitectonica',
      copy: 'Conceptos de alto nivel, modelos de dominio y dependencias curados en ICM Memoirs.',
      searchPlaceholder: 'Buscar conceptos, tags, dependencias…',
      noConcepts: 'No se encontraron conceptos arquitectonicos en el memoir.',

...
// La lista vive en su propio módulo desde que este archivo tocó el límite de
// 300 LOC. Se re-exporta porque es parte de la superficie pública de la
// paridad y quien la importa no tiene por qué saber dónde cayó el corte.
export { DEFAULT_SYNC_PATHS } from './sync-paths.mjs'

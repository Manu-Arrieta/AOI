<!-- AOI / .agents/rules/aoi-rules.md — Auto-compiled by aoi:sync-rules -->
# AOI Antigravity Governance Rules (AOI)
...
- SDD workflow prompts are defined in `.github/prompts/<command>.prompt.md` (e.g. `init.prompt.md`, `sdd-genesis.prompt.md`, `sdd-frame.prompt.md`, `sdd-new.prompt.md`, `sdd-apply.prompt.md`, `sdd-verify.prompt.md`, `sdd-archive.prompt.md`).

# Delete Resource Folder (Antigravity)

> Antigravity mirror of `.github/prompts/delete-resource-folder.prompt.md`. Logic is identical.

Delete a governed folder inside `.resources/` while preserving the resources contract and audit trail.

## Activation

This skill activates when the user says: "delete-resource-folder", "eliminar carpeta de recursos", or similar.

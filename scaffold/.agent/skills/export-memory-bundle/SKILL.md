# Export Memory Bundle (Antigravity)

> Antigravity mirror of `.github/prompts/export-memory-bundle.prompt.md`. Logic is identical.
...
This skill activates when the user says: "export-memory-bundle", "exportar
memorias", "export memory bundle", or similar.

...
> "Sandbox `{sandbox-name}` created. You can start prototyping. When ready to integrate, use `/sdd-verify` to validate, then the Integration Specialist will generate a migration plan."

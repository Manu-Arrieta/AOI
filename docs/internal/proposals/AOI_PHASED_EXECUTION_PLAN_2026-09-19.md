...
| **M5 #2** | `skills/rtk/SKILL.md` `228` tok · banda `8.083`/fase · ciclo `56.581` | el trigger que el agente lee para decidir si carga la skill | **`226` tok · banda `8.081`/fase · ciclo `56.567` · payload literal `95.987 → 95.977`** | **−2/fase = −14/ciclo** | `a3ff2655f9d9e8c7` → **`486956ce1a3e33cf`** | 2026-09-20 |
| **G1** | 42 superficies de claim · la wiki, `README.es.md` y las skills **fuera** | el alcance del ledger, recursivo y compartido con su test | **65 superficies** · 7 de 16 archivos de wiki y los 12 claims de `README.es.md` retirados | **0 tokens** (instrumento) | `486956ce1a3e33cf` (la wiki y el README no son banda) | 2026-09-20 |
